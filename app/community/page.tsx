      ...
      <div className="container-custom">
        ...
        <div className="card p-8 mb-12 animate-fade-in" style={{ animationDelay: "0.2s" }}>
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2 bg-gray-100 dark:bg-dark-200 rounded-xl p-6 h-64 flex items-center justify-center animate-float">
              <div className="text-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-16 w-16 mx-auto text-pink-500 dark:text-purple-400 mb-4"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-gray-700 dark:text-gray-300 font-medium">discord.gg/rSZJGSr5FW</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card p-8 mb-12 animate-fade-in" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/2">
              <div className="bg-pink-50 dark:bg-dark-200 p-6 rounded-xl hover-scale">
                <h3 className="text-xl font-semibold mb-4 dark:text-gray-200">How It Works</h3>
            ...
            <div className="w-full md:w-1/2">
              <h3 className="text-xl font-semibold mb-4 dark:text-gray-200">Why We Use a Key System</h3>
              ...
              <div className="bg-amber-50 dark:bg-dark-200 border border-amber-300 dark:border-amber-800 rounded-lg p-4">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            {faqs.map((faq, index) => (
              <div key={index} className="card p-6 hover-scale">
                <h3 className="text-lg font-semibold mb-2 dark:text-gray-200">{faq.question}</h3>
